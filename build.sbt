...
pomExtra := (
	<url>https://github.com/liftmodules/oauth</url>
	<licenses>
		<license>
	 ...
	 <scm>
	    <url>git@github.com:liftmodules/oauth.git</url>
	    <connection>scm:git:git@github.com:liftmodules/oauth.git</connection>
	 </scm>
	 <developers>
	    <developer>
	      <id>liftmodules</id>
